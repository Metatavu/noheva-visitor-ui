...
class DevicesApi {
  ...
  Future<Response<Device>> createDevice({ 
    ...
    final _path = r'/v1/fleet/devices';
  ...
  Future<Response<void>> deleteDevice({ 
    ...
    final _path = r'/v1/fleet/devices/{deviceId}'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Device] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Device>> findDevice({ 
    required String deviceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DeviceKey] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DeviceKey>> getDeviceKey({ 
    required String deviceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/fleet/devices/{deviceId}/key'.replaceAll('{' r'deviceId' '}', deviceId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DeviceKey? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DeviceKey),
      ) as DeviceKey;
  ...
  Future<Response<BuiltList<Device>>> listDevices({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(DeviceStatus)),
      if (approvalStatus != null) r'approvalStatus': encodeQueryParameter(_serializers, approvalStatus, const FullType(DeviceApprovalStatus)),
    };
